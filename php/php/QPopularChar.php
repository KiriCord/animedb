...
<div class="container">
    <div class="m-2 mb-3">
        <div class="bodyMain">
            ...
            <?
            $query = "select first_name_char, second_name_char, alias, count(*) as amount from the_character join character_to_title ctt on the_character.id = ctt.id_character group by the_character.id order by amount desc";
