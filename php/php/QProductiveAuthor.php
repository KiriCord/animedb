...
<div class="container">
    <div class="m-2 mb-3">
        <div class="bodyMain">
            ...
            <?
            $query = "select first_name, second_name, count(*) as amount from author join titles t on author.id = t.id_author group by author.id order by amount desc limit 1";
