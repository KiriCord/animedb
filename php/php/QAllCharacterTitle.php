...
<div class="container">
    <div class="m-2 mb-3">
        <div class="bodyMain">
            ...
            <?
            $query = "SELECT the_character.id as tc_id, first_name_char, second_name_char, alias, t.id as t_id, t.title as t_t
                        FROM the_character
                            JOIN character_to_title ctt on the_character.id = ctt.id_character
                            JOIN titles t on t.id = ctt.id_title WHERE id_title=?;";
            echo Utils::renderSelectQueryToTable($query, [$_POST['all_title_char']]);
            echo "<hr>";
