...
<div class="container">
    <div class="m-2 mb-3">
        <div class="bodyMain">
            ...
            <?
            $query = "select name_genre, count(*) as amount from genre_title join title_to_genre ttg on genre_title.id = ttg.id_genre group by genre_title.id order by amount desc limit 1";
