...
<div class="list-group list-group-horizontal tableMenu m-2 p-2">
    ...
    <a class="list-group-item list-group-item-action active" href="/php/TStudio.php">Студии</a>
...
<script>
    function update_values(id) {
        ...
        const request = async () => {
            const response = await fetch(`${location.protocol}//${current_host}/php/api/get_studio_by_id.php?id=${id}`);
        ...
        <div class="m-3 p-1 workdbdiv">
            ...
            <div style="display: flex; flex-direction: column;">
                ...
                <div class="input-group p-3">
                    ...
                    <input id='name_studio' name="name_studio" type="text" class="form-control" aria-label="Название студии">
                </div>
